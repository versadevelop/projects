    ...
    public class DamageUI : MonoBehaviour
    {
        ...
        public class ActiveText
        {
            ...
            public void PlaceText(Camera cam, Canvas canvas)
            {
                ...
                Vector3 pos = WorldPositionStart + new Vector3(ratio, Mathf.Sin(ratio * Mathf.PI/2), 0);
        ...
        public void NewDamage(float amount, Vector3 worldPos, bool wasCritical, Color color)
        {       
            ...
            at.Timer = at.MaxTime;
            at.UIText = t;
            at.UIText.fontSize = 25;
            at.UIText.color = color;
            at.WorldPositionStart = worldPos + Vector3.up;
            if (wasCritical){at.Timer = 1.2f; at.UIText.color = Color.yellow; at.WorldPositionStart = worldPos + Vector3.up * 3;}
            at.PlaceText(m_MainCamera, m_Canvas);
        
            m_ActiveTexts.Add(at);
        }

         public void NewHealing(float amount, Vector3 worldPos, Color color)
        {       
            var t = m_TextPool.Dequeue();
