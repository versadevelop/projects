...
namespace Tears_Of_Void.Items
{
    ...
    public abstract class BaseElementalEffect : IEquatable<BaseElementalEffect>
    {
        ...
        public virtual void Applied(AIHealth target)
        {
            m_Timer = m_Duration;
            m_Target = target;
        }
        ...
        public virtual void Update(BaseStats statSystem)
        {
    ...
    {
        int m_Damage;
        BaseStats.DamageType m_DamageType;
        float m_DamageSpeed;
        ...
        public ElementalEffect(float duration, BaseStats.DamageType damageType, int damage, float speed = 1.0f) :
            base(duration)
        {
            m_Damage = damage;
        ...
        public override void Update(BaseStats statSystem)
        {
            ...
            if (m_SinceLastDamage > m_DamageSpeed)
            {
                ...
                Weapons.AttackData data = new Weapons.AttackData(m_Target);
        ...
        public override void Applied(AIHealth target)
        {
            base.Applied(target);
